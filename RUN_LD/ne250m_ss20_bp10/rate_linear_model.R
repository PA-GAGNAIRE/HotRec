...
df <- read.table("/home/RUN_LD/ne250m_ss20_bp10/All_recombination_rate.txt", header = FALSE, sep="\t") #resultats simulations msprime
...
write.csv(df1, file = "/home/RUN_LD/ne250m_ss20_bp10/large_scale_hotspot_recap_lm.csv")
