...
pos <- read.table("/home/RUN_LD/ne25m_ss20_bp50/POS.txt", header = FALSE, sep="\t") #fichiers des positions et des alleles de reference
...
write.table(anc,file="/home/RUN_LD/ne25m_ss20_bp50/anc_prior.txt", sep =" ", quote = F, dec = ".", col.names = FALSE, row.names = FALSE)
